...
export const ButtonsCard = ({
    ...
    return (
        <div
            onClick={onClick}
            className={cn(
                "h-60 w-full max-w-5xl mx-auto bg-white rounded-xl border border-neutral-100 dark:bg-black dark:border-white/[0.2] overflow-hidden relative flex items-center justify-center",
                className
            )}
        >
            <div className="absolute inset-0 dark:bg-dot-white/[0.1] bg-dot-black/[0.1]" />

            {/* If you don’t want hover behavior, make it always visible or remove it */}
            {/* <IconClipboard className="absolute top-2 right-2 text-neutral-300 h-4 w-4" /> */}
