            ...
            <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 py-12 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="md:col-span-1 space-y-8">
                        <div>
                            <h3 className="text-xl font-bold font-heading bg-clip-text text-transparent bg-gradient-to-r from-white to-neutral-400 mb-4">The Percentage Company</h3>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-white/20 transition-colors w-full"
                                />
                                <button className="bg-white hover:bg-neutral-200 text-black p-2 rounded-lg transition-colors">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="#services" className="text-sm text-neutral-400 hover:text-white transition-colors duration-300">
                                    Inventory Sync
                                </a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="#testimonials" className="text-sm text-neutral-400 hover:text-white transition-colors duration-300">
                                    About Us
                                </a>
                            </li>
                            <li>
                                <a href="#how-it-works" className="text-sm text-neutral-400 hover:text-white transition-colors duration-300">
                                    How It Works
                                </a>
                            </li>
                            <li>
                                <a href="#contact" className="text-sm text-neutral-400 hover:text-white transition-colors duration-300">
                                    Contact
                                </a>
                            </li>
                        </ul>
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6">
                        ...
                        <a href="https://www.instagram.com/thepercentagecompany" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
